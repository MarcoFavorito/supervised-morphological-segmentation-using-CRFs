...
def exec_demo(demo_params):
    ...
    extra_points_train_data = data_parsers.make_dataset.parse_file(open(train_file_extra_points))
    ...
    print_log(logger, "delta: %s\tF-score, : %s" % (best_model_num, delta_evaluation["F-score"]))
